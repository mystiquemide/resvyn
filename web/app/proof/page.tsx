      ...
      <main id="main" className="container-x" style={{ paddingBlock: "clamp(36px, 5vw, 60px)" }}>
        <header style={{ maxWidth: 900 }}>
          ...
          <p className="lead" style={{ marginTop: 16 }}>
            This is the hardened Resvyn deployment powering the live app today. A merchant funded a native BOT reserve, issued buyer-bound coverage, the buyer opened an evidence-bound claim, Resvyn's production evaluator authorized the payout, and the reserve reconciled back to zero after settlement.
          </p>
